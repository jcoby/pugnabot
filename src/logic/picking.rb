...
module PickingLogic
  ...
  def choose_captains
    ...
    captains.each do |captain|
      notice captain, "You have been selected as a captain. When it is your turn to pick, you can choose players with the '!pick num' or '!pick name' command. Be sure to medic if you added up as medic captain otherwise you will be temporarily restricted."
    end
  end
