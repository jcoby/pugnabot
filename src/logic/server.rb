...
module ServerLogic
  ...
  def advertisement
    message "Servers are provided by #{ colourize "Command Channel", const["colours"]["green"] }: #{ colourize "https://commandchannel.com", const["colours"]["green"] }"
  end
end
